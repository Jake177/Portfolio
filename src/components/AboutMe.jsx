...
const AboutMe = () => {
  return (
  <section id='aboutme' className='relative min-h-screen w-full gradient-bg particles-bg text-yellow-500 px-6 py-24 sm:py-28 isolate'>
      {/* 装饰性光晕 */}
      ...
      <div className='max-w-6xl mx-auto grid lg:grid-cols-[0.9fr,1.1fr] gap-12 lg:gap-16 items-start'>
        <div className='space-y-6 fade-in-up'>
          ...
          <h2 className='special-font text-4xl sm:text-5xl leading-tight max-w-xl text-gradient'>I transform complex requirements into grounded, measurable cloud strategy.</h2>
